    ...
    public class MainViewModel : Notifiable
    {
        ...
        public void SortBy(string property, ListSortDirection direction)
        {
            using (AssetsView.DeferRefresh())
            {
                ...
                AssetsView.SortDescriptions.Add(new SortDescription(property, direction));
            }
        }
